...
class CheckoutView(EcomMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            order = form.save()
            if pm == "Khalti":
                return redirect(reverse("shop:khaltirequest") + "?o_id=" + str(order.id))
            elif pm == "Esewa":
                return redirect(reverse("shop:esewarequest") + "?o_id=" + str(order.id))
        else:
...
class PasswordResetView(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if user is not None and password_reset_token.check_token(user, token):
            ...
            return redirect(reverse("shop:passworforgot") + "?m=e")
...
class AdminProductCreateView(AdminRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy("shop:adminproductlist")
